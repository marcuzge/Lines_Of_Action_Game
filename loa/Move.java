...
class Move {
    ...
    /** get the direction of the move. @return getDirection */
    ...
    /** get the horizontal direction of the move. @return gethorizontalDir */
    int gethorizontalDir() {
        int dc;
        if (_col1 > _col0) {
            dc = 1;
        } else if (_col1 < _col0) {
    ...
    /** get the vertical direction of the move. @return getverticalDir */
    int getverticalDir() {
        int dr;
        if (_row1 > _row0) {
            dr = 1;
